...
testset_adress = '/content/drive/MyDrive/SYS843/Github/sr/SRGAN_leftt/data/Set5'

#test_set = TestDatasetFromFolder('data/test', upscale_factor=UPSCALE_FACTOR)
test_set = TestDatasetFromFolder(testset_adress, upscale_factor=UPSCALE_FACTOR)
