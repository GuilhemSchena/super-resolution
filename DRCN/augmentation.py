...
training_filenames = util.get_files_in_directory("/content/drive/MyDrive/SYS843/Github/sr/datasets/General100/")  #ScSR
augmented_directory = "/content/drive/MyDrive/SYS843/Github/sr/datasets/T91_aug/"  #ScSR2
